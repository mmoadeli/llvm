...
template <sycl::ext::oneapi::experimental::matrix::use Use>
struct amdgcn_matrix_use {
};

template<>
struct amdgcn_matrix_use<sycl::ext::oneapi::experimental::matrix::use::a> {
  using type = /*rocwmma::matrix_a*/ int;
};

template<>
struct amdgcn_matrix_use<sycl::ext::oneapi::experimental::matrix::use::b> {
  using type = /*rocwmma::matrix_b*/ int;
};

template <>
struct amdgcn_matrix_use<sycl::ext::oneapi::experimental::matrix::use::accumulator> {
  using type = /*rocwmma::accumulator*/ int;
};

template <sycl::ext::oneapi::experimental::matrix::layout layout>
struct amdgcn_matrix_layout {
};

template <>
struct amdgcn_matrix_layout<sycl::ext::oneapi::experimental::matrix::layout::row_major> {
  using type = /*rocwmma::row_major*/ int;
};

template <>
struct amdgcn_matrix_layout<sycl::ext::oneapi::experimental::matrix::layout::col_major> {
  using type = /*rocwmma::col_major*/ int;
};

template <typename T, sycl::ext::oneapi::experimental::matrix::use Use,
          uint32_t BlockN, uint32_t BlockM, uint32_t BlockK,
          sycl::ext::oneapi::experimental::matrix::layout Layout =
              sycl::ext::oneapi::experimental::matrix::layout::dynamic,
          typename Cond = void>
struct joint_matrix_hip {
  using type = rocwmma::fragment<amdgcn_matrix_use<Use>::type, BlockN, BlockM, BlockK,
            amdgcn_matrix_layout<Layout>::type>;
}
